    ...
    return (
        <div className='fixed bg-black bg-opacity-60 top-0 left-0 bottom-0 right-0 z-50 flex justify-center items-center' onClick={onClose}>
            ...
            >
                ...
                <p className='my-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat, qui. Nostrum tempora aut autem eum dolores fugit eligendi suscipit officia ratione et?</p>
